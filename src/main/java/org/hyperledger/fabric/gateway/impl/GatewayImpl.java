...
public final class GatewayImpl implements Gateway {
    ...
    public static final class Builder implements Gateway.Builder {
        ...
        @Override
        public Gateway.Builder networkConfig(InputStream input) throws GatewayException {
                    // looks like JSON
                try {
                    ccp = NetworkConfig.fromYamlStream(input);
                } catch (InvalidArgumentException e1) {
                    e1.printStackTrace();
                } catch (NetworkConfigurationException e1) {
                    e1.printStackTrace();
                }
